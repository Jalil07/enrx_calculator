...
class OtherLinksPage extends StatefulWidget {
  const OtherLinksPage({super.key});

  @override
  State<OtherLinksPage> createState() => _OtherLinksPageState();
}

class _OtherLinksPageState extends State<OtherLinksPage> {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const FittedBox(
          ...
          child: Text('Other Links', style: TextStyle(color: Colors.white),),
        ),
        ...
        actions: [
          Padding(
            ...
            child: TextButton(
              onPressed: () {
                String subject =
                    'EN RX Calculator: Sharing Other Link';
                String body = '';
                              ...
                              Expanded(
                                ...
                                child: Container(
                                  ...
                                  TextButton(
                                    onPressed: () {
                                      String subject =
                                          'EN RX Calculator: Report Other Link (${item['Company']})';
                                      String body = '';
                                      _launchGmail(subject, body);
                                    },
                                    child: const Text(
